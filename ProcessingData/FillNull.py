...
#         df_all['Date Time'] = pd.to_datetime(y + '-' + df_all.pop('Month') + '-' + df_all.pop('Day') + ' ' + df_all.pop('Hour'))
...
#                     df_prior_time = df_prior.loc[len(df_prior) - 1]['Date Time']
#                     df_temp = df_prior.loc[i - delta_hours + h + 1]
